...
namespace Examiner.Infrastructure.Migrations
{
    ...
    [Migration("20230712182913_CountryAndState")]
            ...
            modelBuilder.Entity("Examiner.Domain.Entities.Content.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "NG",
                            CreatedDate = new DateTime(2023, 7, 12, 19, 29, 12, 739, DateTimeKind.Local).AddTicks(592),
                            Title = "Nigeria"
                        });
                });
            ...
            modelBuilder.Entity("Examiner.Domain.Entities.Content.State", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CountryId = 1,
                            CreatedDate = new DateTime(2023, 7, 12, 19, 29, 12, 739, DateTimeKind.Local).AddTicks(649),
                            Title = "Abia"
                        },
                        new
                        {
                            Id = 2,
                            CountryId = 1,
                            CreatedDate = new DateTime(2023, 7, 12, 19, 29, 12, 739, DateTimeKind.Local).AddTicks(750),
                            Title = "Adamawa"
                        },
                        new
                        {
                            Id = 3,
                            CountryId = 1,
                            CreatedDate = new DateTime(2023, 7, 12, 19, 29, 12, 739, DateTimeKind.Local).AddTicks(765),
                            Title = "AkwaIbom"
                        });
                });
            ...
            modelBuilder.Entity("Examiner.Domain.Entities.Content.Subject", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 7, 12, 19, 29, 12, 739, DateTimeKind.Local).AddTicks(241),
                            SubjectCategoryId = 1,
                            Title = "Chemistry"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 7, 12, 19, 29, 12, 739, DateTimeKind.Local).AddTicks(432),
                            SubjectCategoryId = 1,
                            Title = "Physics"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2023, 7, 12, 19, 29, 12, 739, DateTimeKind.Local).AddTicks(451),
                            SubjectCategoryId = 1,
                        ...
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2023, 7, 12, 19, 29, 12, 739, DateTimeKind.Local).AddTicks(465),
                            SubjectCategoryId = 2,
                            Title = "History"
                        },
                        new
                        {
                            Id = 5,
                            CreatedDate = new DateTime(2023, 7, 12, 19, 29, 12, 739, DateTimeKind.Local).AddTicks(485),
                            SubjectCategoryId = 2,
                            Title = "Government"
                        },
                        new
                        {
                            Id = 6,
                            CreatedDate = new DateTime(2023, 7, 12, 19, 29, 12, 739, DateTimeKind.Local).AddTicks(508),
                            SubjectCategoryId = 2,
                            Title = "Economics"
                        },
                        new
                        {
                            Id = 7,
                            CreatedDate = new DateTime(2023, 7, 12, 19, 29, 12, 739, DateTimeKind.Local).AddTicks(522),
                            SubjectCategoryId = 3,
                            Title = "Sociology"
                        },
                        new
                        {
                            Id = 8,
                            CreatedDate = new DateTime(2023, 7, 12, 19, 29, 12, 739, DateTimeKind.Local).AddTicks(536),
                            SubjectCategoryId = 3,
                            Title = "Geography"
                        },
                        new
                        {
                            Id = 9,
                            CreatedDate = new DateTime(2023, 7, 12, 19, 29, 12, 739, DateTimeKind.Local).AddTicks(550),
                            SubjectCategoryId = 3,
            ...
            modelBuilder.Entity("Examiner.Domain.Entities.Content.SubjectCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 7, 12, 19, 29, 12, 739, DateTimeKind.Local).AddTicks(117),
                            Title = "Science"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 7, 12, 19, 29, 12, 739, DateTimeKind.Local).AddTicks(187),
                            Title = "Art"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2023, 7, 12, 19, 29, 12, 739, DateTimeKind.Local).AddTicks(201),
