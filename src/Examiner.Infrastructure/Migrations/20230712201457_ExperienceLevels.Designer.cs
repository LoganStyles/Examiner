...
namespace Examiner.Infrastructure.Migrations
{
    ...
    [Migration("20230712201457_ExperienceLevels")]
    partial class ExperienceLevels
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Examiner.Domain.Entities.Content.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "NG",
                            CreatedDate = new DateTime(2023, 7, 12, 21, 14, 56, 819, DateTimeKind.Local).AddTicks(6965),
                            Title = "Nigeria"
                        });
                });
            ...
            modelBuilder.Entity("Examiner.Domain.Entities.Content.ExperienceLevel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 7, 12, 21, 14, 56, 819, DateTimeKind.Local).AddTicks(7046),
                            Title = "Low"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 7, 12, 21, 14, 56, 819, DateTimeKind.Local).AddTicks(7063),
                            Title = "Moderate"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2023, 7, 12, 21, 14, 56, 819, DateTimeKind.Local).AddTicks(7081),
                            Title = "High"
                        });
                });
            ...
            modelBuilder.Entity("Examiner.Domain.Entities.Content.State", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CountryId = 1,
                            CreatedDate = new DateTime(2023, 7, 12, 21, 14, 56, 819, DateTimeKind.Local).AddTicks(6994),
                            Title = "Abia"
                        },
                        new
                        {
                            Id = 2,
                            CountryId = 1,
                            CreatedDate = new DateTime(2023, 7, 12, 21, 14, 56, 819, DateTimeKind.Local).AddTicks(7011),
                            Title = "Adamawa"
                        },
                        new
                        {
                            Id = 3,
                            CountryId = 1,
                            CreatedDate = new DateTime(2023, 7, 12, 21, 14, 56, 819, DateTimeKind.Local).AddTicks(7025),
                            Title = "AkwaIbom"
                        });
                });
            ...
            modelBuilder.Entity("Examiner.Domain.Entities.Content.Subject", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 7, 12, 21, 14, 56, 819, DateTimeKind.Local).AddTicks(6783),
                            SubjectCategoryId = 1,
                            Title = "Chemistry"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 7, 12, 21, 14, 56, 819, DateTimeKind.Local).AddTicks(6807),
                            SubjectCategoryId = 1,
                            Title = "Physics"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2023, 7, 12, 21, 14, 56, 819, DateTimeKind.Local).AddTicks(6820),
                            SubjectCategoryId = 1,
                        ...
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2023, 7, 12, 21, 14, 56, 819, DateTimeKind.Local).AddTicks(6834),
                            SubjectCategoryId = 2,
                            Title = "History"
                        },
                        new
                        {
                            Id = 5,
                            CreatedDate = new DateTime(2023, 7, 12, 21, 14, 56, 819, DateTimeKind.Local).AddTicks(6848),
                            SubjectCategoryId = 2,
                            Title = "Government"
                        },
                        new
                        {
                            Id = 6,
                            CreatedDate = new DateTime(2023, 7, 12, 21, 14, 56, 819, DateTimeKind.Local).AddTicks(6890),
                            SubjectCategoryId = 2,
                            Title = "Economics"
                        },
                        new
                        {
                            Id = 7,
                            CreatedDate = new DateTime(2023, 7, 12, 21, 14, 56, 819, DateTimeKind.Local).AddTicks(6905),
                            SubjectCategoryId = 3,
                            Title = "Sociology"
                        },
                        new
                        {
                            Id = 8,
                            CreatedDate = new DateTime(2023, 7, 12, 21, 14, 56, 819, DateTimeKind.Local).AddTicks(6922),
                            SubjectCategoryId = 3,
                            Title = "Geography"
                        },
                        new
                        {
                            Id = 9,
                            CreatedDate = new DateTime(2023, 7, 12, 21, 14, 56, 819, DateTimeKind.Local).AddTicks(6936),
                            SubjectCategoryId = 3,
            ...
            modelBuilder.Entity("Examiner.Domain.Entities.Content.SubjectCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 7, 12, 21, 14, 56, 819, DateTimeKind.Local).AddTicks(6645),
                            Title = "Science"
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 7, 12, 21, 14, 56, 819, DateTimeKind.Local).AddTicks(6722),
                            Title = "Art"
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2023, 7, 12, 21, 14, 56, 819, DateTimeKind.Local).AddTicks(6755),
